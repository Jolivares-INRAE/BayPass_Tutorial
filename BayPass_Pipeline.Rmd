...
```{r work-space}
path_vcf <- "C:/BayPass_pipeline/vcf/"    #dossier contenant les .vcf
path_input <- "C:/BayPass_pipeline/Input/"  #dossier destination des fichiers d'entrées BayPass
path_out <- "C:/BayPass_pipeline/Output/CTI/" #dossier contenant les fichiers de sorties BayPass 
path_POD <- "C:/BayPass_pipeline/POD/CTI/" #dossier contenant les fichiers de sorties BayPass - POD
path_res <- "C:/BayPass_pipeline/Resultats/" #dossier destination des résultats (plots, liste SNP...)
```
...
write.table(Manplot.thresh$data, row.names = FALSE, file=paste(path_res, "C2_VS_pos_CTI.txt", sep=""), quote = FALSE, sep = "\t")
...
write.table(V.bed, file=paste(path_res, "overlap.bed", sep=""), quote = FALSE, sep = "\t", row.names = FALSE)
```
