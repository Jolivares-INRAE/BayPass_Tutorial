...
\urlstyle{same}
\hypersetup{
  pdftitle={BayPass 2.3: tutoriel adapté au séquençage en pool},
  pdfauthor={Jérôme OLIVARES},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{BayPass 2.3: tutoriel adapté au séquençage en pool}
