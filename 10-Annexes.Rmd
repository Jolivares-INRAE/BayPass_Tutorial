...
pi.betaK=read.table(paste(path_out, "project.sub3_summary_beta_params.out", sep=""),h=T)$Mean
#créé un jeu de données de 10 000 SNPs
POD_BayPass<-simulate.baypass(omega.mat=omegaB, nsnp = 10000, beta.coef = NA, beta.pi = pi.betaK, sample.size=POD.data$NN, pi.maf=0, suffix="project.POD" )
```
