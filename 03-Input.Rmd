...
```
<p style="font-family: calibri; font-size:11pt; font-style:italic; color:darkgreen">
   La commande **_sed_** prélève une ligne toutes les 100 et les copies dans un fichier **_.sub_** et s'exécute 100 fois pour ballayer tous le fichier initial et créer ainsi 100 fichiers de sous-jeux de données.
</p>
