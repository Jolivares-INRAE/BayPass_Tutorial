...
```{r work-space, echo=FALSE}
path_vcf <- "C:/BayPass/vcf/"
path_input <- "C:/BayPass/Input/13pops/chr1/"
path_out <- "C:/BayPass/Output/13pops/chr1/"
path_POD <- "C:/BayPass/POD/13pops/"
path_res <- "C:/BayPass/Resultats/13pops/chr1/"
path_utils <- "C:/BayPass/utils/"
```
...
#conversion du .vcf
pooldata <- vcf2pooldata(vcf.file = paste(path_vcf, "project.vcf.gz", sep=""),
                         poolsizes = psizes_A,
                         poolnames = pnames,
                         min.cov.per.pool = 4,
                         min.rc = 2,
