...
library(tidyverse)      #manipulation de données et plots (ggplot2)
...
min.rc =  minimum de reads qu'un allèle doit avoir pour être retenu.<br>
...
psizes_A <- as.numeric(c('150', '180', '24', '114', '180', '44','180', '160', '200', '74', '80', '52', '72'))   #ploydie autosome
psizes_X <- as.numeric(c('120', '135', '16', '86', '135', '30','135', '120', '150', '60', '63', '42', '53'))    #ploydie X/Z
psizes_Y <- as.numeric(c('30', '45', '8', '28', '45', '14','45', '40', '50', '14', '17', '10', '19'))           #ploydie Y/W
#conversion du .vcf
GWAS.pooldata <- vcf2pooldata(vcf.file = paste(path_vcf, "project_chr2-28.vcf.gz", sep=""), poolsizes = psizes_A, poolnames = pnames, min.cov.per.pool = 4, min.rc = 2, max.cov.per.pool = 1e+06, min.maf = 0.05, remove.indels = FALSE, nlines.per.readblock = 1e+06)
...
A ce stade on peut analyser cet objet **_GWAS.pooldata_** comme les Fst entre populations par exemple [Annexe 1](#An1)
