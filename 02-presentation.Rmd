...
#conversion du .vcf
pooldata <- vcf2pooldata(vcf.file = paste(path_vcf, "project_chr2-28.vcf.gz", sep=""), poolsizes = psizes_A, poolnames = pnames, min.cov.per.pool = 4, min.rc = 2, max.cov.per.pool = 1e+06, min.maf = 0.05, remove.indels = FALSE, nlines.per.readblock = 1e+06)
...
A ce stade cet objet **_pooldata_** peut être utilisé pour calculer diverses statistiques couremment utilisées dans les études de génomique des populations, un exemple d'estimation de la structure génétique des populations déduite des Fst est donné en [Annexe 1](#An1)
