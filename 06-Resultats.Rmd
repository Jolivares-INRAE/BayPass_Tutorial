...
vd0 <- venn.diagram(v.list, fill = c("lightblue", "lightgreen", "pink"), cat.col = c("blue", "darkgreen", "red"), fontface = "bold", filename = NULL)
grid.newpage()
grid.draw(vd0)
...
cat(paste0(names(table(v.table$intersect)), " n=", table(v.table$intersect)), sep = "\n")
