...
vd0 <- venn.diagram(x=list("BF >=15" = List.SNP2, "XtX top1%" = List.SNP1, "log10.1.pval. top 1%" = List.SNP3), fill = c("lightblue", "lightgreen", "pink"), cat.col = c("blue", "darkgreen", "red"), fontface = "bold", filename = NULL)
grid.newpage()
grid.draw(vd0)
